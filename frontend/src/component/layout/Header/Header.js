...
const useStyles = makeStyles(() => ({
  header: {
    background: "linear-gradient(to right rgb(255, 210, 0) 50%, #978063)",
    paddingRight: "0px",
    paddingLeft: "0px",
    zIndex: 8,
  ...
  toolbar: {
    ...
    background: "linear-gradient(to right, #629fc8, 50%, #c4b8f0)",
  },
  drawerContainer: {
    padding: "50px",
  },
    ...
    },
    {
      label: (
        <Tooltip title="About" arrow TransitionComponent={Zoom}>
          <AttractionsIcon style={{ fontSize: "40PX" }} />
        </Tooltip>
      ),
      href: "/about",
    },
    {
      label: (
        <Tooltip title="Contact" arrow TransitionComponent={Zoom}>
          <LocalPostOfficeIcon style={{ fontSize: "40PX" }} />
        </Tooltip>
      ),
      href: "/contact",
    },
